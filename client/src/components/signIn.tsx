import React, { useState, useRef, ChangeEvent, MutableRefObject, useEffect } from 'react';
...
const SignInIsland = () => {
    ...
    function signInUser(name: string, email: string, orgVal, pass: string, cpass: string){
        // signBtn.current.innerHTML = 'Loading...';
     signBtn.current.disabled = true;

     if(name == "" || email == "" || orgVal == "" || pass == "" || cpass == ""){
    ...
    return (
        <>
            ...
            />
            <span id="error-text" className="hidden">Invalid Email</span>
            <div>
                <button 
            ...
            <h1 
                className="py-3">Have an account? 
